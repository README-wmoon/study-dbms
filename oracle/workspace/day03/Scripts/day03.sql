...
CREATE TABLE TBL_STUDENT(
	...
	/*STUDENT_GENDER CHAR(1) DEFAULT 'N' CONSTRAINT BAN_GENDER CHECK(STUDENT_GENDER ='M' OR STUDENT_GENDER = 'W' OR STUDENT_GENDER = 'N')*/
	...
	STUDENT_AGE NUMBER,
	STUDENT_GRADE VARCHAR2(10) CONSTRAINT BAN_GRADE CHECK(STUDENT_GRADE IN ('A+', 'A', 'B+', 'B', 'C+', 'C', 'D+', 'D'))
);
 ...
 * */
CREATE TABLE TBL_ANIMAL(
	ANIMAL_TYPE VARCHAR2(500) CONSTRAINT PK_ANIMAL PRIMARY KEY,
...
CREATE TABLE TBL_CUSTOMER(
	CUST_NAME VARCHAR2(500) CONSTRAINT PK_CUST PRIMARY KEY,
	CUST_AGE NUMBER NOT NULL,
	CUST_ADDRESS VARCHAR2(500) NOT NULL,
	CUST_PHONE VARCHAR2(500) NOT NULL,
	ANIMAL_TYPE VARCHAR2(500),
	CONSTRAINT FK_CUST FOREIGN KEY(ANIMAL_TYPE)
	REFERENCES TBL_ANIMAL(ANIMAL_TYPE)
);
